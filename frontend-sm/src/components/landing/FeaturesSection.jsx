...
import { Image, Heart, Users, Hash, MessageSquare, Bookmark } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
                      SocialMediaApp provides all the tools you need to share your moments.
                    </p>
                </div>
             
                    <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3 mt-16">
                        {features.map((feature, index) => {
                            const IconComponent = iconMap[feature.iconName] || Image;
                            return (
