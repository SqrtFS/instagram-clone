            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                <div className="pt-20 pb-16 sm:pt-24 sm:pb-20 lg:pt-32 lg:pb-28">
                    <div className="text-center">
                        <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                            <span className="block">Share Your Moments with</span>
                            <span className="block text-purple-500">SocialMediaApp</span>
                        </h1>
                        <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                          Connect, share, and discover with friends around the world.
                        </p>
                ...
                <div className="mt-8 text-center">
                    <p className="mt-4 pb-4 text-base text-gray-500">
                       Share your life through photos and videos. Connect with friends, discover new content, and build your community.
                    </p>
                </div>
            </div>
        </div>
